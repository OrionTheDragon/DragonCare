...
public class TamingState extends PersistentState {
    ...
    public static TamingState get(MinecraftServer server) {
        ...
        return overworld.getPersistentStateManager().getOrCreate(
                new PersistentState.Type<>(TamingState::new, TamingState::fromNbt, null),
                STORAGE_KEY
        );
    }
    ...
    public static TamingState fromNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup lookup) {
