...
public class AddonConfig {
    ...
    private static final Map<String, ModConfigSpec.IntValue> STAGE_VALUES = new HashMap<>();

    public static final ModConfigSpec SPEC;

    // Scale Shears (per stage)
    public static final ModConfigSpec.IntValue SHEARS_S2_MIN, SHEARS_S2_MAX, SHEARS_S2_CD;
    public static final ModConfigSpec.IntValue SHEARS_S3_MIN, SHEARS_S3_MAX, SHEARS_S3_CD;
    public static final ModConfigSpec.IntValue SHEARS_S4_MIN, SHEARS_S4_MAX, SHEARS_S4_CD;
    public static final ModConfigSpec.IntValue SHEARS_S5_MIN, SHEARS_S5_MAX, SHEARS_S5_CD;

    // Syringe (per stage)
    public static final ModConfigSpec.IntValue SYRINGE_S1_USES, SYRINGE_S1_WIN, SYRINGE_S1_CD, SYRINGE_S1_MIN, SYRINGE_S1_MAX;
    public static final ModConfigSpec.IntValue SYRINGE_S2_USES, SYRINGE_S2_WIN, SYRINGE_S2_CD, SYRINGE_S2_MIN, SYRINGE_S2_MAX;
    public static final ModConfigSpec.IntValue SYRINGE_S3_USES, SYRINGE_S3_WIN, SYRINGE_S3_CD, SYRINGE_S3_MIN, SYRINGE_S3_MAX;
    public static final ModConfigSpec.IntValue SYRINGE_S4_USES, SYRINGE_S4_WIN, SYRINGE_S4_CD, SYRINGE_S4_MIN, SYRINGE_S4_MAX;
    public static final ModConfigSpec.IntValue SYRINGE_S5_USES, SYRINGE_S5_WIN, SYRINGE_S5_CD, SYRINGE_S5_MIN, SYRINGE_S5_MAX;

    // Painkiller
    public static final ModConfigSpec.IntValue PAINKILLER_CD;
    public static final ModConfigSpec.IntValue PAINKILLER_DURABILITY;

    // Dragon
    public static final ModConfigSpec.IntValue DRAGON_MAX_HEALTH;
    public static final ModConfigSpec.BooleanValue WILD_DRAGONS_AGE;
    public static final ModConfigSpec.BooleanValue TAMED_DRAGONS_AGE;
    public static final ModConfigSpec.BooleanValue PREVENT_DRAGON_FIGHT_BABIES;
    public static final ModConfigSpec.BooleanValue PREVENT_DRAGON_FIGHT_ALL;

    // Dragon AI & Spawning
    public static final ModConfigSpec.BooleanValue DISABLE_BABY_PANIC;
    public static final ModConfigSpec.BooleanValue DISABLE_NEW_BABY_AI;
    public static final ModConfigSpec.BooleanValue DISABLE_WILD_BABY_SPAWNS;
    public static final ModConfigSpec.BooleanValue MOTHER_PRIORITY_OVER_FOOD;
    public static final ModConfigSpec.IntValue ROOST_SPAWN_RATE;

    // Taming
    public static final ModConfigSpec.IntValue TAMING_DURATION_SECONDS;
    public static final ModConfigSpec.DoubleValue TAMING_PENALTY_MULTIPLIER;

    // Dragon Dirt
    public static final ModConfigSpec.BooleanValue DIRT_ENABLED_TAMED;
    public static final ModConfigSpec.BooleanValue DIRT_ENABLED_WILD;
    public static final ModConfigSpec.DoubleValue DIRT_SPEED_DAYS;
    public static final ModConfigSpec.BooleanValue DIRT_EASY_MINIGAME;

    // Ash Poisoning
    public static final ModConfigSpec.BooleanValue ASH_POISONING_ENABLED;
    public static final ModConfigSpec.BooleanValue ASH_SENSOR_SOUND_ENABLED;
    public static final ModConfigSpec.IntValue ASH_STAGE_1;
    public static final ModConfigSpec.IntValue ASH_STAGE_2;
    public static final ModConfigSpec.IntValue ASH_STAGE_3;
    public static final ModConfigSpec.IntValue ASH_STAGE_4;
    ...
    private static void shearsStage(ModConfigSpec.Builder b, String stageKey, int min, int max, int cdSec) {
    ...
    private static void syringeStage(ModConfigSpec.Builder b, String stageKey, int uses, int winSec, int cdSec) {
    ...
    public static int ticksFromSeconds(ModConfigSpec.IntValue secondsValue) {
