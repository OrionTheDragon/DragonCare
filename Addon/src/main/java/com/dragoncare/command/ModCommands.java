...
public final class ModCommands {
    ...
    private static int giveGuildMap(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            net.minecraft.item.map.MapState.addDecorationsNbt(map, targetPos, "+dragoncare_guild", net.minecraft.item.map.MapDecorationTypes.RED_X);
            
            // Add localized custom name
            map.set(net.minecraft.component.DataComponentTypes.CUSTOM_NAME, Text.translatable("item.dragoncare.guild_map"));
