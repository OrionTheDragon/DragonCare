...
public final class VillageForgeState extends PersistentState {
    ...
    /** Reusable state type — avoids re-allocating it on every {@link #get} call. */
    private static final PersistentState.Type<VillageForgeState> TYPE = new PersistentState.Type<>(
            VillageForgeState::new,
            VillageForgeState::fromNbt,
            null);
    ...
    public static VillageForgeState fromNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
