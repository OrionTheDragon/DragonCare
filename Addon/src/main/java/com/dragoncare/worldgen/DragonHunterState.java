...
public final class DragonHunterState extends PersistentState {
    ...
    /** Reusable state type — allocating this per {@link #get} call was wasteful
     *  (get() is hit from chunk-load events and per-block-entity processing). */
    private static final PersistentState.Type<DragonHunterState> TYPE = new PersistentState.Type<>(
            DragonHunterState::new,
            DragonHunterState::fromNbt,
            null);
    ...
    public static DragonHunterState fromNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registries) {
