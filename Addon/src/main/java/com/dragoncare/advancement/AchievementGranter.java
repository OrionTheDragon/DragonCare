...
public final class AchievementGranter {
    ...
    public static void checkAndUnlockThreeElements(ServerPlayerEntity player) {
        ...
        AdvancementEntry fire = server.getAdvancementLoader().get(TAMED_FIRE_DRAGON);
        AdvancementEntry ice = server.getAdvancementLoader().get(TAMED_ICE_DRAGON);
        AdvancementEntry lightning = server.getAdvancementLoader().get(TAMED_LIGHTNING_DRAGON);
