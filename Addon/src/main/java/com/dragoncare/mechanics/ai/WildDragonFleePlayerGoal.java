 ...
 * navigation is killed each tick — making a naive flee goal useless.
 *
...
public class WildDragonFleePlayerGoal extends Goal {
    private static final Identifier FLEE_SPEED_MODIFIER =
            Identifier.of("dragoncare", "wild_dragon_flee_speed");
    ...
    public WildDragonFleePlayerGoal(DragonBaseEntity dragon, double distance, double speedMultiplier) {
        this.dragon = dragon;
    ...
    private void applySpeedBoost() {
        ...
        if (speedAttr != null && speedAttr.getModifier(FLEE_SPEED_MODIFIER) == null) {
            ...
            speedAttr.addTemporaryModifier(new EntityAttributeModifier(
                    FLEE_SPEED_MODIFIER, baseSpeed, EntityAttributeModifier.Operation.ADD_VALUE));
        }
    }
