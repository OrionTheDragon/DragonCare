...
public class DragonFamilyManager {
    ...
    public static void linkFamily(DragonBaseEntity mother, DragonBaseEntity baby) {
    ...
    public static DragonBaseEntity getMother(DragonBaseEntity baby) {
        ...
        if (entity instanceof DragonBaseEntity mother) {
            return mother;
        }
        return null;
    }
    ...
    public static List<DragonBaseEntity> getLoadedBabies(DragonBaseEntity mother) {
        List<DragonBaseEntity> loadedBabies = new ArrayList<>();
        MinecraftServer server = mother.getServer();
        ...
        for (UUID babyId : motherData.babyIds) {
            ...
            if (entity instanceof DragonBaseEntity baby) {
    ...
    public static boolean isFamily(DragonBaseEntity d1, DragonBaseEntity d2) {
     ...
     */
    public static void callMotherForHelp(DragonBaseEntity baby, LivingEntity threat) {
        DragonBaseEntity mother = getMother(baby);
    ...
    public static void onDragonDeath(DragonBaseEntity dragon) {
