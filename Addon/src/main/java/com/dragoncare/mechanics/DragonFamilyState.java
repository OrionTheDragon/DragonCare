...
public class DragonFamilyState extends PersistentState {
    ...
    public static DragonFamilyState get(MinecraftServer server) {
        ...
        return overworld.getPersistentStateManager().getOrCreate(
                new PersistentState.Type<>(DragonFamilyState::new, DragonFamilyState::fromNbt, null),
                STORAGE_KEY
        );
    }
    ...
    public static DragonFamilyState fromNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup lookup) {
