...
public class DragonPainkillerItem extends Item {
    ...
    public ActionResult useOnEntity(ItemStack stack, PlayerEntity user, LivingEntity entity, Hand hand) {
        ...
        // only — plain HashMap is safe here).
        ...
        if (stage5) {
            ...
            if (firstUse != null && now - firstUse <= STAGE5_PAIR_WINDOW_TICKS) {
                ...
                // First dose (or expired pair) — record and skip cooldown
        ...
        dragon.addStatusEffect(new StatusEffectInstance(ModEffects.PAINKILLING, EFFECT_DURATION_TICKS, 0));
