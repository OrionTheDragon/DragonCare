...
public class ModItems {
    ...
    public static final DeferredRegister.Items ITEMS =
            DeferredRegister.createItems(DragonCare.MOD_ID);

    public static final DeferredItem<SyringeItem> DRAGON_BLOOD_SYRINGE = ITEMS.register(
            "dragon_blood_syringe",
            () -> new SyringeItem(new Item.Settings().maxCount(1).maxDamage(240))
    );

    public static final DeferredItem<ExceptionalDragonMealItem> EXCEPTIONAL_DRAGON_MEAL = ITEMS.register(
            "exceptional_dragon_meal",
            () -> new ExceptionalDragonMealItem(new Item.Settings())
    );

    public static final DeferredItem<ScaleShearsItem> SCALE_SHEARS = ITEMS.register(
            "scale_shears",
            () -> new ScaleShearsItem(new Item.Settings().maxCount(1).maxDamage(520))
    );

    public static final DeferredItem<DragonPainkillerItem> DRAGON_PAINKILLER = ITEMS.register(
            "dragon_painkiller",
            () -> new DragonPainkillerItem(new Item.Settings().maxCount(1).maxDamage(getPainkillerDurability()))
    );

    public static final DeferredItem<DragonBrushItem> DRAGON_BRUSH = ITEMS.register(
            "dragon_brush",
            () -> new DragonBrushItem(new Item.Settings().maxCount(1).maxDamage(120))
    );

    public static final DeferredItem<Item> DRACOMANIA_ICON = ITEMS.register(
            "dracomania_icon",
     ...
     */
    public static final DeferredItem<DragonFruitItem> DRAGON_FRUIT = ITEMS.register(
            "dragon_fruit",
    ...
    public static final DeferredItem<DragonFruitSeedsItem> DRAGON_FRUIT_SEEDS = ITEMS.register(
            "dragon_fruit_seeds",
    ...
    public static final DeferredItem<DragonPhoneItem> DRAGON_PHONE = ITEMS.register(
            "dragon_phone",
            () -> new DragonPhoneItem(new Item.Settings().maxCount(1))
    );

    public static final DeferredItem<AshTabletsItem> ASH_TABLETS = ITEMS.register(
            "ash_tablets",
            () -> new AshTabletsItem(new Item.Settings().maxCount(1))
    );

    /** Сгоревший лист — некрафтящийся свиток с заранее сгенерированным текстом. */
    public static final DeferredItem<AshSensorItem> ASH_SENSOR = ITEMS.register(
            "ash_sensor",
            () -> new AshSensorItem(new Item.Settings().maxCount(1))
    );

    public static final DeferredItem<BurntSheetItem> BURNT_SHEET = ITEMS.register(
            "burnt_sheet",
    ...
    public static final DeferredHolder<ItemGroup, ItemGroup> ADDON_TAB = CREATIVE_TABS.register(
            "addon_tab",
            () -> ItemGroup.builder()
