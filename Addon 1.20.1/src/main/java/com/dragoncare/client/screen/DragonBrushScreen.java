...
public class DragonBrushScreen extends Screen {
    ...
    public DragonBrushScreen(EntityDragonBase dragon, int dirtLevel) {
    ...
    private void checkGameConditions() {
        ...
        if (currentScore >= targetScore - 0.01) {
            ...
            com.dragoncare.network.ModNetwork.INSTANCE.sendToServer(new DragonBrushCleanPayload(dragon.getUuid(), newDirtLevel, 0));
        ...
        // Check Failure
            ...
            com.dragoncare.network.ModNetwork.INSTANCE.sendToServer(new DragonBrushCleanPayload(dragon.getUuid(), startDirtLevel, 1));
