...
public class DragonPhoneScreen extends Screen {
    ...
    protected void init() {
        ...
        addDrawableChild(ButtonWidget.builder(Text.translatable("screen.dragoncare.dragon_phone.refresh"),
                b -> com.dragoncare.network.ModNetwork.INSTANCE.sendToServer(new RefreshListPayload()))
        ...
        if (button == 0) {
            ...
            if (mouseX >= listLeft && mouseX < listRight && mouseY >= listTop && mouseY < listBottom) {
                ...
                if (idx >= 0 && idx < view.size()) {
                    ...
                    selected = newSel;
                    com.dragoncare.network.ModNetwork.INSTANCE.sendToServer(new SelectDragonPayload(
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double amount) {
        scrollY = Math.max(0, scrollY - amount * ROW_HEIGHT);
        return true;
    }
