...
public class ParentProtectBabiesGoal extends Goal {
    ...
    private final EntityDragonBase parent;
    private final double maxDistance;
    private final double speed;
    private EntityDragonBase targetBaby;
    private int checkCooldown = 0;
    private int pathingTimeout = 0;
    private int pathUpdateTicks = 0;

    public ParentProtectBabiesGoal(EntityDragonBase parent, double maxDistance, double speed) {
        this.parent = parent;
    ...
    public boolean canStart() {
        ...
        List<EntityDragonBase> babies = DragonFamilyManager.getLoadedBabies(parent);
        if (babies.isEmpty()) {
        ...
        EntityDragonBase farthestBaby = null;

        for (EntityDragonBase baby : babies) {
