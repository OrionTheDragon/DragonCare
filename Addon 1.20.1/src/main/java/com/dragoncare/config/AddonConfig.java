...
public class AddonConfig {
    ...
    // Structures
    public static final ForgeConfigSpec.BooleanValue DISABLE_ALL_STRUCTURES;
    public static final ForgeConfigSpec.BooleanValue DISABLE_GUILD;
    public static final ForgeConfigSpec.BooleanValue DISABLE_HUNTER_HOUSE;
    public static final ForgeConfigSpec.BooleanValue DISABLE_VILLAGE_FORGE;
    public static final ForgeConfigSpec.DoubleValue GUILD_SPAWN_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue HUNTER_HOUSE_SPAWN_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue VILLAGE_FORGE_SPAWN_MULTIPLIER;
